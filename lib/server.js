 ...
 * @param {string} opts.coin[='btc'] - The coin for this wallet (btc, crw).
 ...
 * @param {string} opts.coin[='btc'] - The expected coin for this wallet (btc, crw).
 ...
 * @param {String} [opts.provider] - A provider of exchange rates (default 'BitPayPlus').
